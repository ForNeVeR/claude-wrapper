...
3. Update the existing or create a new key named `ForNeVeR.ClaudeWrapper.github` with a permission to **Push only new package versions** and only allowed to publish the package **ClaudeWrapper**.
...
[github.secrets]: https://github.com/ForNeVeR/ClaudeWrapper/settings/secrets/actions
